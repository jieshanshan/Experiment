...
repo = Repo('D:/sonarqube/projects/cloudstack-gcestack')
...
project_name = r'cloudstack-gcestack'
...
#file_path = r'D:\sonarqube\to_analyze\cloudstack-documentation-test'
#file_name_prefix_repository = r'cloudstack-documentation-'
#file_ext_name = r'.zip'
#url_prefix = r'https://github.com/apache/cloudstack-documentation/archive/'
#file = open(r'D:\sonarqube\to_analyze\cloudstack-documentation-test' + '.bat','w')
...
#    old_dirpath = os.path.join(file_path, file_name) + '\\' + r'airflow-' + each[SHA]
